...
async function createTables() {
  const schema = `
    ...
    CREATE TABLE IF NOT EXISTS pressure_sore_wounds (
      ...
      initial_stage VARCHAR(50),
      wound_length DECIMAL(6,2),
      wound_width DECIMAL(6,2),
      wound_depth DECIMAL(6,2),
      undermining BOOLEAN DEFAULT FALSE,
      undermining_details TEXT,
      tunneling BOOLEAN DEFAULT FALSE,
      tunneling_details TEXT,
      wound_bed_tissue JSONB DEFAULT '{}',
      granulation_percent DECIMAL(5,2) DEFAULT 0,
      slough_percent DECIMAL(5,2) DEFAULT 0,
      eschar_percent DECIMAL(5,2) DEFAULT 0,
      exudate_type VARCHAR(50),
      exudate_amount VARCHAR(50),
      wound_edges VARCHAR(100),
      peri_wound_skin VARCHAR(255),
      infection_signs JSONB DEFAULT '[]',
      probe_to_bone BOOLEAN DEFAULT FALSE,
      odor BOOLEAN DEFAULT FALSE,
      pain_level INTEGER,
      braden_score INTEGER,
      braden_risk VARCHAR(50),
      photos JSONB DEFAULT '[]',
      notes TEXT,
      status VARCHAR(50) DEFAULT 'active',
      assessed_by INTEGER REFERENCES users(id),
    ...
    CREATE TABLE IF NOT EXISTS pressure_sore_treatment_plans (
      ...
      patient_name VARCHAR(255),
      stage VARCHAR(50),
      wound_care_protocol JSONB DEFAULT '{}',
      dressing_type VARCHAR(255),
      dressing_frequency VARCHAR(100),
      debridement_method VARCHAR(255),
      offloading_device VARCHAR(255),
      repositioning_schedule VARCHAR(255),
      nutrition_plan JSONB DEFAULT '{}',
      supplements JSONB DEFAULT '[]',
      antibiotics JSONB DEFAULT '[]',
      surgical_plan JSONB DEFAULT '{}',
      flap_option VARCHAR(255),
    ...
    CREATE TABLE IF NOT EXISTS pressure_sore_progress (
      ...
      wound_bed_tissue JSONB DEFAULT '{}',
      infection_signs JSONB DEFAULT '[]',
      peri_wound_status VARCHAR(255),
      healing_trend VARCHAR(50) DEFAULT 'stable',
      healing_rate DECIMAL(5,2),
      current_stage VARCHAR(50),
      repositioning_compliance BOOLEAN DEFAULT TRUE,
      nutrition_compliance BOOLEAN DEFAULT TRUE,
